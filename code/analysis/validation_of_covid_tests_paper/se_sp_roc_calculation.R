# This is main analysis for the "Evaluation of the performance of
...
load("data/validation_of_covid_tests/full_dataset.rda")
load("data/validation_of_covid_tests/full_abbott.rda")
load("data/validation_of_covid_tests/full_genetico.rda")
load("data/validation_of_covid_tests/full_vector.rda")
load("data/validation_of_covid_tests/full_roche.rda")
