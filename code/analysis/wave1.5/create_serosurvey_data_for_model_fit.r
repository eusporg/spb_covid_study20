...
# Load Abbott results from the wave 1.5, created by extraneous code
load("data/wave1.5/test_results/test_B/test_B_results_matched_to_phone_survey_ids.rdata")

# Load Genetico results from the wave 1.5, created by extraneous code
...
# Load the test results from the first wave
first_wave_env <- new.env()
load("data/wave1/test_results/test_B/test_B_results_matched_to_phone_survey_ids.rdata", first_wave_env)
load("data/wave1/test_results/test_C/test_C_results_matched_to_phone_survey_ids.rdata", first_wave_env)
first_wave_env[["test_C_results_matched_to_phone_survey_ids"]][IgA_or_G_or_M_testC_quantitative >= 1, IgA_or_G_or_M_testC := 1]
first_wave_env[["test_C_results_matched_to_phone_survey_ids"]][IgA_or_G_or_M_testC_quantitative < 1, IgA_or_G_or_M_testC := 0]
...
# Mark as infected the ones infected in the first wave
# AND those that came to the second wave
serosurvey_data[ ID %in% first_wave_env[["test_B_results_matched_to_phone_survey_ids"]][IgG_testB == 1]$ID & IgG_testB == 0, IgG_testB := 1]
serosurvey_data[ ID %in% first_wave_env[["test_C_results_matched_to_phone_survey_ids"]][IgA_or_G_or_M_testC == 1]$ID & IgA_or_G_or_M_testC == 0, IgA_or_G_or_M_testC := 1]
